 ...
 *
 * correction bug N°1 = remise à zero des variables Shift et ShiftBas à partir du C quand on reprogramme une ligne fixe
...
const char *strs[18]  = {"\r","<t1>","<t2>","<c1>","<c2>","<b1>"
...
__delay32(1000000);  // delay de 1.000.000 cycles
 ...
 // correction USART first missing Charactere at power on
//U1MODEbits.LPBACK = 1;// loopback USART
//__delay32(1000000);  // delay de 10.000.000 cycles indispensable
//imprime ("a\r");
//__delay32(1000000);  // delay de 10.000.000 cycles indispensable
